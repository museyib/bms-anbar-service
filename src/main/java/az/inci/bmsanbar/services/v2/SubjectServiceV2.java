...
@Service
public class SubjectServiceV2 extends AbstractService
{
    ...
    public List<Customer> getCustomerList(String sbeCode)
    {
        ...
        Query q = em.createNativeQuery(
                "SELECT BM.BP_CODE,BM.BP_NAME,SM.SBE_CODE,SM.SBE_NAME FROM SBE_BP SB " +
    ...
    public List<Whs> getTrgWhsList(String userId)
    {
        List<Whs> whsList = new ArrayList<>();
        Query q = em.createNativeQuery(
                "SELECT WM.WHS_CODE,WM.WHS_NAME FROM BMS_USER_WHS BUW " +
    ...
    public List<ExpCenter> getExpCenterList()
    {
        ...
        Query q = em.createNativeQuery(
                "SELECT EXP_CENTER_CODE, EXP_CENTER_DESC " +
